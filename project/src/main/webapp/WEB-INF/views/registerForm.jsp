...
<form action="<c:url value="/register/join"/>" method="post" onsubmit="return formCheck(this);">
    ...
    <input class="input-field" type="text" name="pwd2" placeholder="8~12자리의 영대소문자와 숫자 조합">
    <label for="">이름</label>
